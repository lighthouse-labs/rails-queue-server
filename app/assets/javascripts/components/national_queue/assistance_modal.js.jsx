...
window.NationalQueue.AssistanceModal = ({request, student, setRef}) => {
  ...
  const handleEndAssistance = () => {
    ...
    if (request) {
      endAssistance(request, notes, rating, notify);
    } else {
      providedAssistance(student, notes, rating, notify);
    }
  }

  const endAssistance = (request, notes, rating, notify) => {
  ...
  return (
    <div className="modal fade" ref={setRef}>
