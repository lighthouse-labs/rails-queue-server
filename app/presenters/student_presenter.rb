class StudentPresenter < UserPresenter
  ...
  def quiz_stats
    ...
    quiz_average = (student.quiz_submissions.inject(0.0) { |total, submission| total + (submission.score.to_f / submission.quiz.questions.count)} / student.quiz_submissions.count * 100).to_i
