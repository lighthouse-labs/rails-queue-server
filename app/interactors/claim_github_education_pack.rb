class ClaimGithubEducationPack
  ...
  def call
    ...
    context.url = "https://education.github.com/student/verify?school_id=#{school_id}&student_id=#{URI.encode_www_form_component(student_id)}&signature=#{URI.encode_www_form_component(signature)}"
